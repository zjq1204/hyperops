<template>
  <div class="min-h-screen flex items-center justify-center px-4 py-12">
    <div class="surface-panel-strong w-full max-w-md rounded-[2rem] p-10 text-center">
      <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-[1.4rem] bg-slate-950 text-white shadow-[0_18px_40px_rgba(15,23,42,0.2)]">
      ...
      <div v-if="error" class="mt-6 rounded-[1.2rem] border border-rose-200 bg-rose-50/90 p-4 text-rose-700">{{ error }}</div>
    </div>
  </div>
</template>
